...
var conversation = new Conversation({
  ...
  'username': '<<Watson Conversation User Name>>',
...
var workspace = process.env.WORKSPACE_ID || '<<Watson Conversation workspaceID>>;
//var payload = {};
appPost ();
...
app.post('/api/message', function(req, res) {
  ...
  if (!workspace || workspace !== '<<Watson Conversation workspaceID>>') {
    return res.json({
      'output': {
